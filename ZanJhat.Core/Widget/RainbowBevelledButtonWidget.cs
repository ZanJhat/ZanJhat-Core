...
{
    public class RainbowBevelledButtonWidget : ButtonWidget
    {
        public RainbowBevelledRectangleWidget m_rectangleWidget;

        public RectangleWidget m_imageWidget;

        public RainbowLabelWidget m_labelWidget;
        ...
        public RainbowBevelledButtonWidget()
        {
            Color = Color.White;
            BevelSize = 2f;
            XElement node = ContentManager.Get<XElement>("Widgets/RainbowBevelledButtonContents");
            LoadChildren(this, node);
            m_rectangleWidget = Children.Find<RainbowBevelledRectangleWidget>("BevelledButton.Rectangle");
            m_imageWidget = Children.Find<RectangleWidget>("BevelledButton.Image");
            m_labelWidget = Children.Find<RainbowLabelWidget>("BevelledButton.Label");
